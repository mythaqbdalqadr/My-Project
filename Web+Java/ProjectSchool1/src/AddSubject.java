...
public Subjects(){
    ...
    public Subjects(int ID, String Name, String Mints, String Img, Teachers Teacher) {
        this.ID = ID;
        this.Name = Name;
        this.Mints = Mints;
        this.Img = Img;
       ...
       public Subjects(int ID, String Name, String Mints, String Img) {
        this.ID = ID;
        this.Name = Name;
        this.Mints = Mints;
        this.Img = Img;
...
public class AddSubject extends javax.swing.JFrame {
    ...
    public AddSubject() throws SQLException, ClassNotFoundException {
     ...
     for(Teachers s:t){
         ...
         String Name=s.getFirstName()+" "+s.getMidName()+" "+s.getLastName();
       cbTeacher.addItem(Name);
    ...
    private void initComponents() {
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(cbTeacher, 0, 245, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(26, 26, 26)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cbTeacher, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel3))
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            DataBase.AddSubject(txtName3.getText(), "No Img", txtTime.getText());
            JOptionPane.showMessageDialog(null, "Adding Subject :-)");
            
              try {
                  if(cbTeacher.getSelectedIndex()>=0){
                      
                  
         Teachers t=DataBase.SearchTeacherByName((String)cbTeacher.getSelectedItem());
         Subjects s=DataBase.SearchSubjectByName(txtName3.getText());
            
         DataBase.Teaching(t.getID(), s.getID());
                  }else{ JOptionPane.showMessageDialog(null, "Adding SubjectBut No Teacher");}
